...
- (FlybitsRequest * _Nonnull)userNotificationsWithCompletion:(void (^ _Nonnull)(NSArray<PushMessage *> * _Nullable, NSError * _Nullable))completion;
...
/// Determines if the notification passed in is from Flybits.
/// <ul>
///   <li>
///     Parameter:
///     <ul>
///       <li>
///         notification: A dictionary of the root of a notification’s payload.
///       </li>
///     </ul>
///   </li>
/// </ul>
- (BOOL)isFlybitsNotification:(NSDictionary<NSString *, id> * _Nonnull)notification SWIFT_WARN_UNUSED_RESULT;
/// Determines if the notification passed in is silent.
/// \param notification A dictionary of the root of a notification’s payload.
///
- (BOOL)isSilentNotification:(NSNotification * _Nonnull)notification SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, PushMessageAction, closed) {
/// custom
  PushMessageActionCustom = 0,
/// content
  PushMessageActionContent = 1,
/// website
  PushMessageActionWebsite = 2,
/// Generated by Concierge for local notifications if downloading content before displaying
/// notification.
/// openConcierge
  PushMessageActionOpenConciergeNotifications = 3,
  PushMessageActionOpenContent = 4,
  PushMessageActionOpenContentAndOpenConciergeNotifications = 5,
/// CRUD minus the “Read” - CUD operations
  PushMessageActionCreated = 6,
/// CRUD minus the “Read” - CUD operations
  PushMessageActionUpdated = 7,
/// CRUD minus the “Read” - CUD operations
  PushMessageActionDeleted = 8,
  PushMessageActionChanged = 9,
};

/// Push message category types
typedef SWIFT_ENUM(NSInteger, PushMessageCategory, closed) {
/// custom
  PushMessageCategoryCustom = 0,
/// core
  PushMessageCategoryCore = 1,
/// context
  PushMessageCategoryContext = 2,
/// kernel
  PushMessageCategoryKernel = 3,
/// push
  PushMessageCategoryPush = 4,
};

/// Push message entity types
typedef SWIFT_ENUM(NSInteger, PushMessageEntity, closed) {
/// any other including basic push message alert
  PushMessageEntityCustom = 0,
/// kernel
  PushMessageEntityGroup = 1,
/// kernel
  PushMessageEntityExperience = 2,
/// kernel
  PushMessageEntityContent = 3,
/// kernel
  PushMessageEntityContentData = 4,
/// kernel
  PushMessageEntityRelevantContent = 5,
/// context
  PushMessageEntityRule = 6,
};


SWIFT_CLASS("_TtC14FlybitsPushSDK11PushPayload")
...
SWIFT_CLASS("_TtC14FlybitsPushSDK18PushPayloadContent")
@interface PushPayloadContent : PushPayload
@end


SWIFT_CLASS("_TtC14FlybitsPushSDK37PushPayloadOpenConciergeNotifications")
@interface PushPayloadOpenConciergeNotifications : PushPayloadContent
@end


SWIFT_CLASS("_TtC14FlybitsPushSDK22PushPayloadOpenContent")
@interface PushPayloadOpenContent : PushPayloadContent
@end


SWIFT_CLASS("_TtC14FlybitsPushSDK34PushPayloadOpenContentAndConcierge")
@interface PushPayloadOpenContentAndConcierge : PushPayloadContent
@end


SWIFT_CLASS("_TtC14FlybitsPushSDK18PushPayloadWebsite")
@interface PushPayloadWebsite : PushPayload
@end
...
typedef SWIFT_ENUM(NSInteger, PushServiceLevel, closed) {
...
typedef SWIFT_ENUM(NSInteger, PushSource, closed) {
...
typedef SWIFT_ENUM(NSInteger, RuleResult, closed) {
/// Evaluates to true
  RuleResultTrue = 1,
/// Evaluates to false
  RuleResultFalse = 2,
