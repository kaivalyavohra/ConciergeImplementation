...
typedef SWIFT_ENUM(NSInteger, StorageType, closed) {
...
@property (nonatomic, copy) NSDate * _Nullable lastReadAt;
@property (nonatomic, copy) NSDate * _Nullable savedAt;
@property (nonatomic, copy) NSString * _Nullable url;
@end

/// Defines all the error that can be return by FlybitsSDK when the cache layer
/// fails or throws exception
typedef SWIFT_ENUM(NSInteger, CacheError, closed) {
/// Token not found
...
typedef SWIFT_ENUM(NSInteger, CocoaError, closed) {
/// Formatting error
...
typedef SWIFT_ENUM(NSInteger, ErrorList, closed) {
/// Array
  ErrorListArray = 0,
};
...
///
/// \param requireAccountActivation Indicates whether users are required to be confirmed before being allowed to access features provided by Flybits. Confirmation can be completed by a user clicking a confirmation link sent to their email address as specified in the registration step. Defaults to false.
///
- (nonnull instancetype)initWithEmail:(NSString * _Nonnull)email password:(NSString * _Nonnull)password firstName:(NSString * _Nonnull)firstName lastName:(NSString * _Nonnull)lastName requireAccountActivation:(BOOL)requireAccountActivation;
...
/// \param requireAccountActivation Indicates whether users are required to be confirmed before being allowed to access features provided by Flybits. Confirmation can be completed by a user clicking a confirmation link sent to their email address as specified in the registration step. Defaults to false.
///
- (nonnull instancetype)initWithEmail:(NSString * _Nonnull)email password:(NSString * _Nonnull)password requireAccountActivation:(BOOL)requireAccountActivation OBJC_DESIGNATED_INITIALIZER;
/// The Identity Provider name.
@property (nonatomic, readonly, copy) NSString * _Nonnull provider;
/// The unique identifier for the Flybits Project that this IDP should connect to.
@property (nonatomic, readonly, copy) NSString * _Nullable projectID;
...
///
- (nullable instancetype)initWithProjectID:(NSString * _Nullable)projectID idProvider:(id <IDP> _Nonnull)idProvider scopes:(NSArray<id <FlybitsScope>> * _Nonnull)scopes OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("Please use static functions to access FlybitsManager");
/// Default initializer to create <code>FlybitsManager</code>.
/// \param projectID Unique Flybits Project ID.
///
/// \param scopes Flybits Scopes to receive updates.
...
///
- (nonnull instancetype)initWithProjectID:(NSString * _Nullable)projectID scopes:(NSArray<id <FlybitsScope>> * _Nonnull)scopes OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("Please use static functions to access FlybitsManager");
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
- (FlybitsRequest * _Nonnull)connectWithCompletion:(void (^ _Nonnull)(User * _Nullable, NSError * _Nullable))completion SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("Please use static version of this method", "connect(idp:customerId:projectId:completion:)");
/// The <code>connect</code> method is responsible for connecting the identity provider to the Flybits.
/// On successful connection, all registered <code>FlybitsScope</code>’s gets notified
/// through the <code>onConnected</code> method.
/// When using <code>FlybitsIDP</code> and requiring account activation, appropriate error codes gets returned
...
/// returns:
/// A cancellable <code>FlybitsRequest</code> object.
- (FlybitsRequest * _Nonnull)connectWithIDP:(id <IDP> _Nonnull)idp completion:(void (^ _Nonnull)(User * _Nullable, NSError * _Nullable))completion SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("Please use static version of this method", "connect(idp:customerId:projectId:completion:)");
/// The <code>connect</code> method is responsible for connecting the identity provider to the Flybits.
/// On successful connection, all registered <code>FlybitsScope</code>’s gets notified
/// through the <code>onConnected</code> method.
/// When using <code>FlybitsIDP</code> and requiring account activation, appropriate error codes gets returned
...
/// returns:
/// A cancellable <code>FlybitsRequest</code> object.
- (FlybitsRequest * _Nonnull)connectWithIDP:(id <IDP> _Nonnull)idp projectId:(NSString * _Nonnull)projectId completion:(void (^ _Nonnull)(User * _Nullable, NSError * _Nullable))completion SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("Please use static version of this method", "connect(idp:customerId:projectId:completion:)");
...
/// returns:
/// A cancellable <code>FlybitsRequest</code> object.
- (FlybitsRequest * _Nonnull)connectWithIDP:(id <IDP> _Nonnull)idp customerId:(NSString * _Nullable)customerId completion:(void (^ _Nonnull)(User * _Nullable, NSError * _Nullable))completion SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("Please use static version of this method", "connect(idp:customerId:projectId:completion:)");
/// The <code>connect</code> method is responsible for connecting the identity provider to Flybits.
/// On successful connection, all registered <code>FlybitsScope</code>’s gets notified
/// through the <code>onConnected</code> method.
/// When using <code>FlybitsIDP</code> and requiring account activation, appropriate error codes gets returned
...
/// returns:
/// A cancellable <code>FlybitsRequest</code> object.
+ (FlybitsRequest * _Nonnull)connectWithIDP:(id <IDP> _Nonnull)idp customerId:(NSString * _Nullable)customerId projectId:(NSString * _Nullable)projectId completion:(void (^ _Nonnull)(User * _Nullable, NSError * _Nullable))completion;
...
/// \param completion A completion closure that returns the disconnected JWT token on success
/// or an <code>NSError</code> if failed.
///
///
/// returns:
/// A cancellable <code>FlybitsRequest</code> object.
+ (FlybitsRequest * _Nonnull)disconnectWithCompletion:(void (^ _Nonnull)(NSString * _Nullable, NSError * _Nullable))completion;
/// The <code>disconnect</code> method is responsible for disconnecting and clearing the session with Flybits.
/// On successfully disconnecting, all registered <code>FlybitsScope</code>’s gets notified
/// through the <code>onDisconnected</code> method.
/// \param completion A completion closure that returns the disconnected JWT token on success
...
/// returns:
/// A cancellable <code>FlybitsRequest</code> object.
- (FlybitsRequest * _Nonnull)disconnectWithCompletion:(void (^ _Nonnull)(NSString * _Nullable, NSError * _Nullable))completion SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("Please use static version of this method", "disconnect(_:completion:)");
+ (void)enableLogging;
/// NSCoding encode
...
typedef SWIFT_ENUM(NSInteger, FlybitsRequestType, closed) {
...
typedef SWIFT_ENUM(NSInteger, JWTError, closed) {
/// Max retries
...
typedef SWIFT_ENUM(NSInteger, LoginError, closed) {
...
typedef SWIFT_ENUM(NSInteger, NetworkingRequestError, closed) {
...
typedef SWIFT_ENUM(NSInteger, SupportedIDP, closed) {
/// Facebook OAuth
...
typedef SWIFT_ENUM(NSInteger, QueryExpressionError, closed) {
/// Not supported
...
/// tell you what data is missing or invalid.
typedef SWIFT_ENUM(NSInteger, RegistrationError, closed) {
/// Missing field/property that is expected to be there for API to function
...
typedef SWIFT_ENUM(NSInteger, ToDictionaryError, closed) {
/// Invalid Coordinate
...
typedef SWIFT_ENUM_NAMED(NSInteger, FlybitsUtilitiesSortOrder, "SortOrder", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, FlybitsUtilitiesSortBy, "SortBy", closed) {
...
/// Length units
typedef SWIFT_ENUM_NAMED(NSInteger, FlybitsUtilitiesLengthUnit, "LengthUnit", closed) {
/// Units in meters
...
/// Time units
typedef SWIFT_ENUM_NAMED(NSInteger, FlybitsUtilitiesTimeUnit, "TimeUnit", closed) {
/// Seconds unit
