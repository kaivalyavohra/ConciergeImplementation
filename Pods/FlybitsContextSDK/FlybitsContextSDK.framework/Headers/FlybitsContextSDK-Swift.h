...
- (void)generatedValueBy:(id <ContextPlugin> _Nonnull)plugin data:(NSArray * _Nonnull)data SWIFT_DEPRECATED_MSG("Please use `generatedValue(by plugin: ContextPlugin, context data: [ContextData], completion: ((Error?) -> Void)?)` instead");
@optional
...
/// Method that will send and update the context data of the currently connected Flybits user
...
- (void)generatedValueBy:(id <ContextPlugin> _Nonnull)plugin data:(NSArray * _Nonnull)data;
- (void)generatedValueBy:(id <ContextPlugin> _Nonnull)plugin context:(NSArray<ContextData *> * _Nonnull)data completion:(void (^ _Nullable)(NSError * _Nullable))completion;
@end
